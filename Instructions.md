...
- Your login: is mfwsuser28@demo.broadcom.com
...
- Your userid is CUST028.
- Your password CUST028.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS28 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS28 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST028.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST028.MARBLES.JCL(MARBCOPY)" --vasc`
...
Username: _JENKINSCUST028
Password: Mfuser28@26
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-28.git`
